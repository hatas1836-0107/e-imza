...
"""
ULTRA MODERN İLÇE SAYFALARI - ANASAYFA DÜZEYİNDE TASARIM
- Ana sayfa ile aynı modern tasarım
- Firebase'den dinamik fiyat çekme
- SEO bombası: Product Schema, FAQPage, LocalBusiness
- Blog section genişletilmiş
- Mahalleler doğru
"""
...
districts = {
    ...
    "pendik-e-imza": {
        ...
        "lat": "40.8764",
        "lon": "29.2331",
        "neighborhoods": ["Bahçelievler", "Batı", "Çamçeşme", "Doğu", "Dumlupınar", "E", "Fevzi Çakmak", "Göçbeyli", "Güllü Bağlar", "Güzelyalı", "Kaynarca", "Kurtköy", "Orta", "Osman Gazi", "Ramazanoğlu", "Sanayi", "Sapanbağları", "Velibaba", "Yenişehir"],
...
"Yenisahra", "Yenişehir"],
    ...
    "sultanbeyli-e-imza": {
        ...
        "lat": "40.9671",
        "lon": "29.2632",
        "neighborhoods": ["Abdurrahmangazi", "Akşemsettin", "Battalgazi", "Hasanpaşa", "Mecidiye", "Mimar Sinan", "Necip Fazıl", "Or", "Yavuz Selim"],
    ...
    "sile-e-imza": {
        ...
        "lat": "41.1769",
        "lon": "29.6159",
        Bucaklı", "Çayırbaşı", "Darlık", "Değirmençayırı", "Doğancılı", "Esenceli", "Geredeli", "Göçe", "Hacıkasım", "İmrendere", "İmrenli", "İvriz", "Kabakoz", "Kalem", "Karacaköy", "Kervansaray", "Kızılca", "Meşrutiyet", "Oruçoğlu", "Ovacık", "Sahilköy", "Satmazlı", "Şuayipli", "Teke", "Yakaköy", "Yazımanayır", "Yeniköy"],
    ...
    "esenyurt-e-imza": {
        ...
        "lat": "41.0259",
        "lon": "28.6779",
        "n"Firuzköy", "Gökevler", "Güzelyurt", "Haramidere", "Havaalanı", "Hoşdere", "İnönü", "İstiklal", "Kapalı", "Kavaklı", "Kemer", "Kıraç", "Mehterçeşme", "Merkez", "Oruçreis", "Pınar", "Saadetdere", "Süleymaniye", "Talatpaşa", "Turgut Özal", "Uysal", "Yamanevler", "Yenikent", "Yeşilkent", "Zafer"],
    ...
    "avcilar-e-imza": {
        ...
        "lat": "40.9790",
        "lon": "28.7212",
        "nzköşkler", "Firuzköy", "Gümüşpala", "Merkez", "Mustafa Kemal Paşa", "Tahtakale", "Üniversite", "Yeşilkent"],
  ...
  "popular": ["Atakent", "Halkalı", "Kanarya"]
    ...
    "esenler-e-imza": {
        ...
        "lat": "41.0437",
        "lon": "28.8792",
        "nazım Karabekir", "Kemer", "Menderes", "Mimarsinan", "Nenehatun", "Nine Hatun", "Oruçreis", "Tuna"],
    ...
    "sariyer-e-imza": {
        ...
        "lat": "41.1682",
        "lon": "29.0531",
y", "Büyükdere", "Demirciköy", "Emirgan", "Ferahevler", "Huzur", "İstinye", "Kireçburnu", "Maslak", "Merkez", "Poligon", "Rumeli Feneri", "Rumelihisarı", "Tarabya", "Uskumruköy", "Yeniköy", "Zekeriyaköy"],
    ...
    "basaksehir-e-imza": {
        ...
        "lat": "41.0922",
        "lon": "28.8059",
        "neighborhoodamlar", "Şahintepe", "Ziya Gökalp"],
    ...
    "fatih-e-imza": {
        ...
        "lat": "41.0201",
        "lon": "28.9499",
        "neighborhoods": ["Aksaray", "Alemdar", "Ali Kuşçu", "Atikali", "Ayvansaray",", "Rüstempaşa", "Sarıdemir", "Seyyid Ömer", "Silivrikapı", "Süleymaniye", "Sururi", "Şehremini", "Şehsuvar Bey", "Tahtakale", "Taya Hatun", "Yavuz Sinan", "Yavuz Sultan Selim", "Zeyrek"],
    ...
    "beyoglu-e-imza": {
        ...
        "lat": "41.0343",
        "lon": "28.9770",
        "neighborhoods": ["Bereketzade", "Bülbül", "Camiikebir", "Cihangir", "Çukur", "Emekyemez", "Evliya Çelebi", "Fetihtepe", "Fmet", "Hacımimi", "Halıcıoğlu", "Hasköy", "Hüseyinağa", "İstiklal", "Kadımehmet", "Kaptanpaşa", "Katip Mustafa Çelebi", "Keçecipiri", "Kemankeş Karamustafa Paşa", "Kılıçalipaşa", "Kocatepe", "Kuloğlu", "Piri Paşa", "Piyalepaşa", "Pürtelaş Hasan Efendi", "Sütlüce", "Şahkulu", "Şehit Muhtar", "Tomtom", "Yenişehir"],
    ...
    "kagithane-e-imza": {
        ...
        "lat": "41.0785",
        "lon": "28.9746",
        "n", "Emniyet Evleri", "Gültepe", "Hamidiye", "Harmantepe", "Merkez", "Nurtepe", "Ortabayır", "Sanayi", "Seyrantepe", "Şirintepe", "Telsizler", "Yahya Kemal", "Yeşilce"],
    ...
    "bayrampasa-e-imza": {
        ...
        "lat": "41.0450",
        "lon": "28.9082",
        "neigspartakule", "Kartaltepe", "Kocatepe", "Muratpaşa", "Orta", "Terazidere", "Yeni", "Yıldırım"],
...
}hborhoods": ["Altıntepsi", "Cevatpaşa", "Eski", "Ieighborhoods": ["Çağlayaniruzağa", "Gümüşsuyu", "Hacıah "Balabanağa", "Balat", "Beyazıt", "Binbirdirek", "Cankurtaran", "Cerrahpaşa", "Çarşamba", "Çemberlitaş", "Demirtaş", "Dervişali", "Eminsinan", "Hacı Kadın", "Hırka-i Şerif", "Hocapaşa", "İskenderpaşa", "Kalenderhane", "Karagümrük", "Katip Kasım", "Kemalpaşa", "Koca Mustafapaşa", "Mercan", "Mevlanakapı", "Mimar Hayrettin", "Mimar Kemalettin", "Molla Fenari", "Molla Gürani", "Molla Hüsrev", "Muhsine Hatun", "Nişanca", "Tayakas": ["Altınşehir", "Bahçeşehir 1. Kısım", "Bahçeşehir 2. Kısım", "Başak", "Başakşehir", "Güvercintepe", "Kayabaşı", "Ş        "neighborhoods": ["Ayazağa", "Bahçeköeighborhoods": ["Atışalanı", "Birlik", "Çiftehavuzlar", "Davutpaşa", "Fatih", "Havaalanı", "K"lon": "28.8575"      eighborhoods": ["Ambarlı", "Cihangir", "Denieighborhoods": ["Akevler", "Akşemsettin", "Ardıçlı", "Aşıklar", "Balıkyolu", "Barbaros", "Battalgazi", "Birlik", "Cumhuriyet", "Dede Gülizar", "Doğan Arafat", "Dumlu", "Esenkent", "Eski", "Fatih", "Ferhatpaşa", "neighborhoods": ["Ağva", "Ahmetli", "Akçakese", "Alacalı", "Avcıkoru", "Balibey", "Bıçkıdere", "hangazi", "Turgut Reis        "neighborhoods": ["Atatürk", "Barbaros", "Esatpaşa", "Ferhatpaşa", "Fetih", "İçerenköy", "İnönü", "Kayışdağı", "Küçükbakkalköy", "Mevlana", "Mustafa Kemal", "Örnek", rtuğrul Gazi", "Esenyalı", "Esenşehir

# ULTRA MODERN TEMPLATE - ANASAYFA GİBİ
...
gtag('js',new Date());
gtag('config','G-315P2FGR91',{send_page_view:true,allow_google_signals:true});
</script>

<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover,user-scalable=yes">
<title>{{DISTRICT}} E-İmza | {{POPULAR_1}}, {{POPULAR_2}}, {{POPULAR_3}} | Aynı Gün Teslimat</title>
<meta name="description" content="{{DISTRICT}} e-imza aynı gün ücretsiz kurye teslimatı. {{ALL_NEIGHBORHOODS}} mahallelerine online başvuru ile 2-4 saat teslimat. 5070 Sayılı Kanuna uygun nitelikli elektronik imza.">
<meta name="keywords" content="{{DISTRICT}} e-imza, {{ALL_NEIGHBORHOODS}}, {{DISTRICT}} e-imza nereden alınır, {{DISTRICT}} e-imza fiyatları, {{DISTRICT}} aynı gün e-imza, {{DISTRICT}} kurye e-imza">
...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "İmza İstanbul - {{DISTRICT}} E-İmza",
  "description": "{{DISTRICT}} e-imza aynı gün teslimatı",
  "telephone": "+905453863407",
  "address": {"@type": "PostalAddress", "addressLocality": "{{DISTRICT}}", "addressRegion": "İstanbul", "addressCountry": "TR"},
...
<header class="site-header">
  <div class="container">
    <a href="anasayfa" class="brand">
      <span class="brand-mark"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 2 3 14h7l-1 8 11-14h-7l0-6Z"/></svg></span>
      <span>İmza İstanbul<small>Aynı Gün Kurye</small></span>
    </a>
    <nav class="main-nav">
...
<section class="hero">
  <div class="container">
    <span class="eyebrow"><span class="dot"></span> {{DISTRICT}} / İSTANBUL</span>
    <h1>{{DISTRICT}} E-İmza<br><span class="grad-text">Aynı Gün Teslimat</span></h1>
    <p class="hero-lead">{{POPULAR_1}}, {{POPULAR_2}}, {{POPULAR_3}} ve tüm mahallelere ücretsiz kurye</p>
    <div class="hero-cta-row">
      <a href="#fiyatlar" class="btn btn-primary btn-lg">Fiyatları İncele</a>
      <a href="https://wa.me/905453863407" class="btn btn-whatsapp btn-lg">WhatsApp</a>
    </div>
  </div>
</section>
...
<section class="section-tight">
  <div class="container">
    <div class="glass" style="padding:36px 40px;">
      <div class="stat-row">
        <div class="stat"><div class="stat-num">2-4h</div><div class="stat-label">Teslimat</div></div>
        <div class="stat"><div class="stat-num">₺0</div><div class="stat-label">Kurye</div></div>
        <div class="stat"><div class="stat-num">127+</div><div class="stat-label">Müşteri</div></div>
        <div class="stat"><div class="stat-num">4.9★</div><div class="stat-label">Puan</div></div>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="section-head">
      <span class="badge-soft badge-indigo">Mahalleler</span>
      <h2>{{DISTRICT}}'de Teslimat Bölgeleri</h2>
    </div>
...
<section class="products-premium-section" id="fiyatlar">
  <canvas id="bgCanvas" class="products-bg-canvas"></canvas>
  <div class="products-container">
    <div class="products-hero">
      <h1>{{DISTRICT}} <span class="accent">E-İmza Fiyatları</span></h1>
      <p>Firebase'den güncel fiyatlar</p>
    </div>
    <div id="productsLoading" style="text-align:center;padding:60px 20px;">
      <div style="display:inline-block;width:48px;height:48px;border:4px solid rgba(79,70,229,0.2);border-radius:50%;border-top-color:#4f46e5;animation:spin 0.8s linear infinite;"></div>
    </div>
    <div id="productsContainer" style="display:none;"><div class="products-grid"></div></div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="section-head">
      <span class="badge-soft badge-indigo">Blog</span>
      <h2>{{DISTRICT}} E-İmza <span class="grad-text">Rehberi</span></h2>
    </div>
    <div class="grid grid-2">
      <div class="card glass">
        <div style="width:100%;height:200px;background:linear-gradient(135deg,#667eea,#764ba2);border-radius:12px;margin-bottom:20px;"></div>
        <h3>{{DISTRICT}}'de E-İmza Nereden Alınır?</h3>
        <p>{{DISTRICT}} {{POPULAR_1}}, {{POPULAR_2}} mahallelerine aynı gün kurye</p>
        <a href="blog-e-imza-nedir" class="btn btn-ghost">Devamını Oku</a>
      </div>
      <div class="card glass">
        <div style="width:100%;height:200px;background:linear-gradient(135deg,#f093fb,#f5576c);border-radius:12px;margin-bottom:20px;"></div>
        <h3>{{DISTRICT}} E-İmza Fiyatları 2026</h3>
        <p>Güncel fiyatlar Firebase'den yüklenir</p>
...
<footer class="footer">
  <div class="container">
    <div class="footer-brand">İmza İstanbul</div>
    <div class="footer-phone"><a href="tel:+905453863407">0 545 386 34 07</a></div>
  </div>
</footer>

<div class="float-stack">
  <a href="https://wa.me/905453863407" class="fab-whatsapp"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12c0 1.85.5 3.58 1.36 5.07L2 22l5.1-1.33A9.94 9.94 0 0 0 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2Z"/></svg></a>
</div>
...
const app=initializeApp({apiKey:"AIzaSyADykV8-GjNNoK30CUkPlqCNMjR7Ggc1M8",databaseURL:"https://e-imza-4c867-default-rtdb.firebaseio.com",projectId:"e-imza-4c867"});
const db=getDatabase(app);
if(window.initProductsBackground)window.initProductsBackground('bgCanvas','bgFallback');
onValue(ref(db,'products'),(s)=>{
  const d=s.val()||{};
  const p=Object.entries(d).map(([id,data])=>({id,...data})).filter(x=>x.status==='active').sort((a,b)=>(a.price||0)-(b.price||0));
  document.getElementById('productsLoading').style.display='none';
  document.getElementById('productsContainer').style.display='block';
  if(window.renderPremiumProducts)window.renderPremiumProducts(p,'productsContainer');
});
</script>
</body>
</html>"""
...
print("✨ ÖZELLIKLER:")
print("  ✅ Ana sayfa ile AYNI modern tasarım")
print("  ✅ Firebase'den DINAMIK fiyat çekme")
print("  ✅ SEO BOMBASI: Product Schema, FAQPage, LocalBusiness")
print("  ✅ Blog section GENİŞLETİLMİŞ")
print("  ✅ Mahalleler DOĞRU")
print("\n")
...
for file, data in districts.items():
    ...
    for n in neighborhoods:
        if n in popular:
            neighborhood_html += f'<div class="neighborhood-tag popular">{n} ⭐</div>\n        '
        else:
            neighborhood_html += f'<div class="neighborhood-tag">{n}</div>\n        '
    
    # Mahalle listesi (SEO için)
    ...
    print(f"✅ {name} - {len(neighborhoods)} mahalle - ULTRA MODERN + Firebase Fiyatlı")

print(f"\n🎉 {len(districts)} ilçe sayfası ULTRA MODERN TASARIMA güncellendi!")
print("\n🔥 SON DURUM:")
print("  ✅ ANASAYFA DÜZEYİNDE TASARIM")
print("  ✅ FİREBASE FİYATLARI OTOMATİK YÜKLEN İR")
print("  ✅ SEO BOMBASI - TÜM GOOGLE ARAÇLARI AKTİF")
print("  ✅ BLOG SECTION GENİŞ VE ETKİLİ")
